<?php
/*
Plugin Name: Report - Blog Comments
Plugin URI: 
Description:
...
reports_add_report('Blog Comments','blog-comments','Displays comment activity for a blog');

if ( $_GET['report'] == 'blog-comments' ) {
...
function report_blog_comments_ouput(){
	...
	switch( $_GET[ 'report-action' ] ) {
		...
		default:
			?>
			<form name="report" method="POST" action="ms-admin.php?page=reports&action=view-report&report=blog-comments&report-action=view">
