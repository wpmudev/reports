...
reports_add_report('User Posts','user-posts','Displays post activity for a user');

if ( $_GET['report'] == 'user-posts' ) {
...
function report_user_posts_ouput(){
	...
	switch( $_GET[ 'report-action' ] ) {
		...
		default:
			?>
			<form name="report" method="POST" action="ms-admin.php?page=reports&action=view-report&report=user-posts&report-action=view">
