...
reports_add_report('Blog Pages','blog-pages','Displays page activity for a blog');

if ( $_GET['report'] == 'blog-pages' ) {
...
function report_blog_pages_ouput(){
	...
	switch( $_GET[ 'report-action' ] ) {
		...
		default:
			?>
			<form name="report" method="POST" action="ms-admin.php?page=reports&action=view-report&report=blog-pages&report-action=view">
